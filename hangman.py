...
class HangmanGame:
    ...
    def choose_word(self):
        words = ['riddhi', 'raju', 'rohit', 'bansi', 'krishna', 'abhi', 'sita', 'jokar', 'vishnu', 'ruhi', 'aarvi']
    ...
    def draw_word(self):
        ...
        self.canvas.create_text(500, 380, text=display_word, font=('Arial', 24))
    ...
    def draw_keyboard(self):
        ...
        for idx, letter in enumerate(alphabet):
            row = idx // 7
            col = idx % 7
            button = tk.Button(self.root, text=letter, width=4, command=lambda l=letter: self.check_letter(l))
            button.place(x=150 + col * 50, y=100 + row * 50)
